...
%%Karte_Schwarz_2
%%------------------------------------------------------------------------------
%\begin{tcolorbox}[colback=white,colframe=black,coltitle=white,adjusted title=2. Dan: Schwarz]
%	\renewcommand{\labelenumi}{\alph{enumi}.)}
%	\renewcommand{\labelenumii}{\arabic*.}
%	{\scriptsize 
%		\begin{tabularx}{\textwidth}{lX}
%			\textit{Voraussetzungen}:& Techniken, Kata\,\&\,Kata-Bunkai des Kanons bis einschliesslich 1. Dan, sowie die notwendige geistige Reife
%		\end{tabularx}\\}
%	\begin{enumerate}[nosep]
%		\item \textit{\textbf{Kihon-Ido}}:
%		\begin{enumerate}[nosep]
...
%%Karte_Schwarz_3
%%------------------------------------------------------------------------------
%\begin{tcolorbox}[colback=white,colframe=black,coltitle=white,adjusted title=3. Dan: Schwarz]
%	\renewcommand{\labelenumi}{\alph{enumi}.)}
%	\renewcommand{\labelenumii}{\arabic*.}
%	{\scriptsize 
	%		\begin{tabularx}{\textwidth}{lX}
...
%%Karte_Schwarz_4
%%------------------------------------------------------------------------------
%\begin{tcolorbox}[colback=white,colframe=black,coltitle=white,adjusted title=4. Dan: Schwarz]
%	\renewcommand{\labelenumi}{\alph{enumi}.)}
%	\renewcommand{\labelenumii}{\arabic*.}
%	{\scriptsize 
	%		\begin{tabularx}{\textwidth}{lX}
...
\begin{tcolorbox}[colback=white,colframe=GKD,coltitle=white,adjusted title=Waffen]
	...
	\begin{tabularx}{\textwidth}{cccc}
		\includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_seiken}	& \includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_teisho}	& \includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_uraken}	& \includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_seiryuto} \\
		Seiken 	& Teish\={o} 	& Uraken 	& Seiry\={u}t\={o}\\
		\includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_tettsui} & \includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_nakadaka_ippon_ken} & \includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_ippon_ken} & \includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_hiraken} \\
		Tettsui 	& Nakadaka 	& Ippon Ken & Hiraken \\
		\includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_haito} & \includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_haishu}	& \includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_koken} & \includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_shuto} \\
		Hait\={o} 	& Haishu 	& Koken 		& Shut\={o} \\	
		\includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_nukite}	& \includegraphics[height=0.12\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_hand_empi} &  & \\
		Nukite 	& Empi 		&  			& \\
	\end{tabularx}
\	null\vfill\null
\end{tcolorbox}
...
\begin{tcolorbox}[colback=white,colframe=GKD,coltitle=white,adjusted title=Waffen]
	\null\vfill\null	
	\begin{tabularx}{\textwidth}{cccc}
		\includegraphics[height=0.18\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_fuss_koshi} 		& \includegraphics[height=0.18\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_fuss_sokuto} 		& \includegraphics[height=0.18\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_fuss_teisoku} &
		\multirow{3}{*}{\includegraphics[height=0.18\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_fuss_haisoku}}
		\\
		Ch\={u}soku 		& Sokut\={o} 	& Teisoku &\\
		\includegraphics[height=0.18\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_fuss_tsumasaki} 	& \includegraphics[height=0.18\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_fuss_hiza} 		&  \includegraphics[height=0.18\textwidth-2\tabcolsep,keepaspectratio]{Gfx/habersetzer/habersetzer_waffen_fuss_kakato} &\\
...
\begin{tcolorbox}[colback=white,colframe=GKD,coltitle=white,adjusted title=Hinweise zu Dachi-Waza]
	...
	\begin{tabularx}{\textwidth}{cccc}
		...
		\includegraphics[width=0.25\textwidth-2\tabcolsep,keepaspectratio]{Gfx/self/nekoashi_dachi.pdf} & \multicolumn{2}{c}{\includegraphics[width=0.5\textwidth-1\tabcolsep,keepaspectratio]{Gfx/self/shiko_dachi.pdf}} & \multirow[t]{3}{*}{\includegraphics[width=0.25\textwidth-2\tabcolsep,keepaspectratio]{Gfx/self/zenkutsu_dachi.pdf}}\\
...
\begin{tcolorbox}[colback=white,colframe=GKD,coltitle=white,adjusted title=Kata des G\={o}j\={u}-Ry\={u} Karate-D\={o}]
	...
	\begin{tabularx}{\linewidth}{XXX}
		...
		\midrule
		{\small Taikyoku J\={o}dan}		&{\small Gekisai-Dai-Ichi}	&{\small Shis\={o}chin}\\
		{\small Taikyoku Ch\={u}dan}	&{\small Gekisai-Dai-Ni}	&{\small Seisan}\\
		{\small Taikyoku Gedan}			&{\small Saif\={a}}			&{\small S\={e}pai}\\
		{\small Taikyoku Kake-Uke}		&{\small S\={e}enchin}		&{\small Kururunf\={a}}\\
		{\small Taikyoku Joshugi}		&{\small Tensh\={o}}		&{\small S\={u}p\={a}rinpei} \textit{(Petch\={u}rin)}\\
		{\small Taikyoku Mawashi-Uke}	&{\small Sanchin}			&\\
										&{\small Sans\={e}ru}		&\\
	\end{tabularx}\\
	{\small	
		\begin{description}
			\item[Taikyoku Katas] Die Taikyoku Katas haben alle das identische Enbusen gemeinsam, sie unterscheiden sich lediglich in der jeweiligen Blocktechnik sowie der Konteraktion
			\begin{description}
...
\begin{tcolorbox}[colback=white,colframe=GKD,coltitle=white,adjusted title=Basiskombination]
	...
	\setlength{\tabcolsep}{6pt}	
	\begin{center}
		\parbox{\textwidth-2\tabcolsep}{Koordinationsübungen im Kihon. Im oberen Block  können Stände und Techniken beliebig gemischt werden. Der untere Block ist zur Übung der Fußbewegungen in der Vorwärts-, bzw. Rückwärtsbewegung gedacht.}
	\end{center}\null\vfill\null
\end{tcolorbox}
%%------------------------------------------------------------------------------
\pagebreak
...
%%SV_Ideen_1
%%------------------------------------------------------------------------------
\begin{tcolorbox}[colback=white,colframe=GKD,coltitle=white,adjusted title=Ideen zur SV]
	\null\vfill\null
	\begin{description}
			\item[Griff zum Hals von vorne] Tori greift mit einer Hand zum Hals (\textit{Revers}) des Uke (\textit{\frqq Johanna-Style}\flqq)
			\begin{description}
				\item[Kontergriff, Eindrehen und erster Konter] mit gleichseitiger Hand die greifende Hand erfassen und fixieren, dabei über diese Seite der Hand zum Tori eindrehen und den anderen Arm hochreißen, mit der Faust unter das Kinn des Tori
				\item[Ausdrehen, zweiter Konter und Ende] wieder ausdrehen, dabei die Hand fixiert halten und mit dem anderen Arm/Ellenbogen zum Kopf des Gegners kontern, kraftvoll auslaufen lassen über Haishu - mit beiden Händen die Hand des Tori fassen und ggfs. Kipphebel mit Abschlusstechnik Mae-Geri
			\end{description}
	\end{description}
	\begin{description}
		\item[Schwinger von vorne] Tori greift an mit Schwinger zum Kopf des Uke
		\begin{description}
			\item[Sen-no-sen] mit gleichseitigem Arm im Sinne von Age-Uke in den angreifenden Arm hinein gleiten, gleichzeitg Uraken-Uchi zum Gesicht des Tori
			\item[Zweiter Konter und Ende] Hiji-Ate zum Oberkörper (\textit{Kopf}) des Tori, dann Abschlusstechnik Mae-Geri
		\end{description}
	\end{description}
	\null\vfill\null
\end{tcolorbox}
