...
%		\item \textit{\textbf{Kihon-Ido}}:
%		\begin{enumerate}[nosep]
%			\item Kombinationssequenz aus Gekisai-Dai-Ichi\tabto{350pt}(Zenkutsu-Dachi)
%			\item Ch\={u}dan Teish\={o}-Uke\bull Uraken-Uchi J\={o}dan-Ch\={u}dan\tabto{350pt}(Sanchin-Dachi)
%			\item Age-Uke\bull Ch\={u}dan Ura-Zuki\bull Oi-Zuki Ch\={u}dan\tabto{350pt}(Shiko-Dachi 45°)
%			\item Kake-Uke\bull Kansetsu-Geri\tabto{350pt}(Neko-Ashi-Dachi)
%		\end{enumerate}
%		\vspace{12pt}
%		\item \textit{\textbf{Kata}}:\tabto{200pt}\textit{\textbf{Kata\,Bunkai}}:
%		\begin{enumerate}[nosep]
...
%		\end{enumerate}
%		\vspace{12pt}
%		Unsere Abteilung empfiehlt die Teilnahme an Lehrgängen auf Landes-, oder Bundesebene, um den Horizont des eigenen Karate beständig zu erweitern
%	\end{enumerate}
%\end{tcolorbox}
%------------------------------------------------------------------------------
%\pagebreak
...
%	{\scriptsize 
	%		\begin{tabularx}{\textwidth}{lX}
		%			\textit{Voraussetzungen}:& Techniken, Kata\,\&\,Kata-Bunkai des Kanons bis einschliesslich 2. Dan, sowie die notwendige geistige Reife
		%		\end{tabularx}\\}
%	\begin{enumerate}[nosep]
	%		\item \textit{\textbf{Kihon-Ido}}:
	%		\begin{enumerate}[nosep]
...
%	{\scriptsize 
	%		\begin{tabularx}{\textwidth}{lX}
		%			\textit{Voraussetzungen}:& Techniken, Kata\,\&\,Kata-Bunkai des Kanons bis einschliesslich 3. Dan, sowie die notwendige geistige Reife
		%		\end{tabularx}\\}
%	\begin{enumerate}[nosep]
	%		\item \textit{\textbf{Kihon-Ido}}:
	%		\begin{enumerate}[nosep]
