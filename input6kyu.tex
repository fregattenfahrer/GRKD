\begin{tcolorbox}[width=\textwidth,height=\textheight,right=12pt,left=12pt,colframe=GBELT,colback=white,fonttitle=\bfseries,coltitle=white,title=6. Kyu:\indent Kihon-Ido Kata - Partnerformen - Erwartungshorizont]	
	\null\vfill\null
	...
	\begin{tabularx}{\textwidth}{lllllXr}
		...
		%\midrule
		\multicolumn{7}{p{\linewidth-2\tabcolsep}}{{\scriptsize Vorausgesetzte Techniken:\,Zuki, Age-Uke, Yoko-Uke, Harai-Otoshi-Uke, Soto-Uke, Mawashi-Uke, Kake-Uke, Uraken-Uchi, Empi-Age-Uchi, Mae-Geri, Mawashi-Geri, Kansetsu-Geri}}\\
		\midrule
	\end{tabularx}\\
	\null\vfill\null
	%%------------------------------------------------------------------------------
	...
	\begin{minipage}[t]{0.45\textwidth}
		\begin{tabularx}{\textwidth}{cX}
			\midrule
			\multirow{2}*{\textbf{\textit{Kata}}}&Gekisai Dai-Ichi\\
			&Gekisai Dai-Ni\\
			\midrule
		\end{tabularx}
	\end{minipage}
	...
	\begin{minipage}[t]{0.45\textwidth}
		\begin{tabularx}{\textwidth}{Xr}
			...
			3 Nage-Waza		&\textit{{\small Option: SV}} \\
			\midrule
		\end{tabularx}
	\end{minipage}\\
	\null\vfill\null
	{\small 		\begin{tabularx}{\textwidth}{ll}
			...
			&	G\={o} und J\={u} sollten bereits erkennbar dargestellt werden\\
			\midrule
	\end{tabularx}}\\\null\vfill\null
\end{tcolorbox}					