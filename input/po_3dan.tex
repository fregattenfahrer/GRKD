...
%	\end{tabularx}\\}
	\begin{enumerate}[nosep]
		...
		\begin{enumerate}[nosep]
			\item Harai-Otoshi	Uke/Ch\={u}dan Mae-Geri/J\={o}dan Jun-Zuki\tabto{335pt}(Zenkutsu-Dachi)
			\item Ura Kake-Uke/Zukame/Teisho-Ate\tabto{335pt}(Sanchin-Dachi)
			\item Teisho-Uke/Ch\={u}dan Ura-Zuki\tabto{335pt}(Shiko-Dachi 45°)
			\item Haishu-Uke/Mae-Geri Ch\={u}dan\tabto{335pt}(Neko-Ashi-Dachi)
		\end{enumerate}
		\vspace{12pt}
